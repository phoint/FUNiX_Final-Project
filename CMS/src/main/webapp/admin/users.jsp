...
<div class="page-header">
	<h2 class="d-inline-flex mr-3">Users</h2>
...
<div class="wrap my-1">
	...
	<div class="d-inline-flex mr-2">
		<form class="form-inline" action="users" method="get">
			...
			<c:if test="${empty searchKey}"><button type="submit" class="btn btn-sm btn-outline-primary mx-1">Search</button></c:if>
		</form>
			<c:if test="${not empty searchKey}"><a href="<c:url value="users"/>" role="button" class="btn btn-sm btn-outline-primary mx-1">Clear</a></c:if>
	</div>
</div>
<div class="table-responsive">
	...
	<form action="<c:url value="users"/>" id="pagination-info">
		<input type="hidden" name="searchKey" value="${searchKey}"> <input
			type="hidden" name="maxItem" id="maxItem" /> <input type="hidden"
